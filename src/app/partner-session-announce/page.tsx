  ...
  return (
    <>
      ...
      <section className="hero">
        <div className="container">
          <div className="hero-inner">
            <div className="hero-badge"><span className="hero-badge-dot"></span>3プログラム統合・90分・参加費無料</div>
            <h1><span className="gold">共犯者</span>になって、<br />一緒に稼ごう。<br />KAMOファンディング<br />パートナーシップ説明会</h1>
            ...
            <div className="hero-meta">
              <div className="hero-meta-item"><span className="kamo-icon kamo-icon-clock sm"></span> 90分</div>
        ...
        <div className="container">
          ...
          <div className="programs-grid">
            ...
            <div className="program-card gold">
              ...
              <span className="barrier barrier-mid">説明会参加</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="table-wrap">
            <table className="ctable">
              ...
              <tbody>
                ...
                <tr><td><strong>ハードル</strong></td><td>登録のみ（無料）</td><td>養成講座（¥128,000）</td><td>説明会参加</td></tr>
      ...
      <section className="schedule" id="schedule">
        <div className="container">
          <div className="schedule-title"><h2>開催<span className="accent">日程</span></h2></div>
          <div className="schedule-list">
            <div className="schedule-item">
              <div className="schedule-date"><div className="month">予定</div><div className="day">--</div><div className="weekday">調整中</div></div>
              <div className="schedule-info"><h4>第1回 パートナーシップ説明会</h4><p>90分 | オンライン（Zoom）| 3プログラム統合</p></div>
              <div className="schedule-status status-tba">日程調整中</div>
            </div>
          </div>
          <p style={{textAlign:'center',fontSize:'14px',color:'#666',marginTop:'20px'}}>※ 日程確定次第、申込者に優先ご案内します</p>
        </div>
      </section>
      ...
      <section className="cta-banner">
        <div className="container">
          ...
          <p>まずは説明会に参加して、3つのプログラムを知ってください。</p>
      ...
      <section className="form-section" id="apply">
        <div className="container">
          <div className="form-card">
            <h2>パートナーシップ<span className="accent">説明会</span>に申し込む</h2>
            <p className="form-sub">3プログラムの説明会（90分・オンライン・無料）にご参加ください。</p>
            {submitted ? (
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group"><label>質問・メッセージ（任意）</label><textarea name="message" placeholder="説明会で聞きたいこと等があれば"></textarea></div>
