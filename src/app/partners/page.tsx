      ...
      <section className="benefits">
        <div className="container">
          <div className="benefits-grid">
            ...
            <div className="benefit-card"><h4><span className="kamo-icon kamo-icon-yen sm" style={{marginRight:'6px'}}></span>紹介料：総支援金額の約2%</h4><p>紹介した案件のプロジェクト支援金、対象金額の2%が報酬。例：¥1,000,000→¥20,000、¥10,000,000→¥200,000<br />※支援総額ー手数料＋税金＝対象金額<br />※募集終了時に明細を発行し、終了月の翌々月末に指定口座へお支払い</p></div>
