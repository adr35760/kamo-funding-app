...
【書き方（最重要）】
🔴 **各項目は下の【各項目に含める内容】の①〜⑪を、1つにつき1文ずつ、全部書いてください。**
   **①〜⑪の11個すべてを埋めることが必須**です。番号を飛ばした項目は不合格です。
   **1文は35〜45文字程度**で書いてください。11文 × 35〜45字で約400文字になります。
🔴 **ただし1項目の合計は440文字を超えないこと。** 超えるとシステム側で末尾が切られ、
   ⑩⑪の内容が消えてしまいます。**①〜⑪を全部入れ切るために、1文を長くしすぎず
   35〜45字で簡潔にまとめてください。**
...
- vision（実現したい未来）:
  ...
  ⑤事業者自身にとっての変化 ⑥半年後の姿 ⑦1年後の姿 ⑧3年後の姿 ⑨そこで生まれる新しい関係
  ⑩それが続いた先にあるもの ⑪その未来に向けた決意
- appeal（支援者へのメッセージ）:
